...
ActiveRecord::Schema.define(version: 20140723220435) do
  ...
  create_table "users", force: true do |t|
    ...
    t.string   "secret"
    t.string   "avatar_url"
    t.string   "profile_avatar_file_name"
    t.string   "profile_avatar_content_type"
    t.integer  "profile_avatar_file_size"
    t.datetime "profile_avatar_updated_at"
  end
